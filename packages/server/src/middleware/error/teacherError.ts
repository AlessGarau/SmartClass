...
export class TeacherError extends Error {
  ...
  static notFound(message?: string): TeacherError {
    return new TeacherError({
      message: message || ErrorMessageEnum.Teacher.NOT_FOUND,
      statusCode: 404,
    });
  }

  static creationFailed(message?: string, cause?: Error): TeacherError {
    return new TeacherError({
  ...
  static updateFailed(message?: string, cause?: Error): TeacherError {
    return new TeacherError({
  ...
  static alreadyExists(message?: string): TeacherError {
    return new TeacherError({
